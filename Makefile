...
OBJECTS=main.o load.o render.o state.o intro-state.o intro-transition-state.o title-state.o title-transition-state.o title-fall-state.o title-options-state.o game-state.o
OBJECTSOSX=SDLMain.o
OBJECTSLINUX=
CFILES=main.c load.c render.c state.c intro-state.c intro-transition-state.c title-state.c title-transition-state.c title-fall-state.c title-options-state.c game-state.c
OSXEXTRA=SDLMain.m
LINUXEXTRA=
all:
